    ...
    ui(new Ui::helpDialog)
{
    ...
    //ui->plainTextEdit->appendHtml("<u>https://github.com/ethereum-mining/ethminer</u>");
    ui->plainTextEdit->appendHtml("It will restart ethminer for you in case of error...<br>");
    ui->plainTextEdit->appendHtml("If you want to donate you can at this address:<br>");
